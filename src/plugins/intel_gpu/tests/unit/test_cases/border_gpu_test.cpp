...
TEST(border_gpu, basic_bfyx_negative_pad_dynamic) {
    constexpr auto in_size_b = 2;
    constexpr auto in_size_f = 3;
    constexpr auto in_size_y = 5;
    constexpr auto in_size_x = 4;
    ...
    constexpr auto blt_size_f = 1;
    constexpr auto blt_size_y = -3;
    constexpr auto blt_size_x = 2;

    constexpr auto brb_size_b = 3;
    constexpr auto brb_size_f = -1;
    constexpr auto brb_size_y = 1;
    constexpr auto brb_size_x = -3;
...
TEST(border_gpu, basic_bfyx_2x1x2x3_1x2x3x4_border_constant_dynamic_with_split_negative_pad) {
    constexpr auto in_size_b = 2;
    constexpr auto in_size_f = 3;
    constexpr auto in_size_y = 5;
    constexpr auto in_size_x = 4;
