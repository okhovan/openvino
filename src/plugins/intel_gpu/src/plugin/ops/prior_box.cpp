...
static void CreatePriorBoxClusteredOp(Program& p, const std::shared_ptr<ngraph::op::v0::PriorBoxClustered>& op) {
    ...
    pr_attrs.step_width = attrs.step_widths;
    pr_attrs.step_height = attrs.step_heights;
    pr_attrs.variances = attrs.variances;
    ...
    pr_attrs.min_sizes = {};
    pr_attrs.max_sizes = {};
    pr_attrs.aspect_ratios = {};
    pr_attrs.fixed_sizes = {};
    pr_attrs.fixed_ratios = {};
    pr_attrs.densities = {};
    pr_attrs.flip = false;
    pr_attrs.clip = attrs.clip;
...
static void CreatePriorBoxOp(Program& p, const std::shared_ptr<ngraph::op::v0::PriorBox>& op) {
    ...
    pr_attrs.widths = {};
    pr_attrs.heights = {};
    pr_attrs.step_width = false;
    pr_attrs.step_height = false;
    pr_attrs.min_sizes = attrs.min_size;
    pr_attrs.max_sizes = attrs.max_size;
    pr_attrs.aspect_ratios = attrs.aspect_ratio;
    pr_attrs.variances = attrs.variance;
    pr_attrs.fixed_sizes = attrs.fixed_size;
    pr_attrs.fixed_ratios = attrs.fixed_ratio;
    pr_attrs.densities = attrs.density;
