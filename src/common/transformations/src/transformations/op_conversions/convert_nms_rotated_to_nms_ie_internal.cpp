...
ov::pass::ConvertNMSRotatedToNMSIEInternal::ConvertNMSRotatedToNMSIEInternal() {
    ...
    matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        const int center_point_box = 1; //NonMaxSuppression::BoxEncodingType::CENTER
        const auto rotation = nms_rotated->get_clockwise() ?
                op::internal::NonMaxSuppressionIEInternal::Rotation::CLOCKWISE
                : op::internal::NonMaxSuppressionIEInternal::Rotation::COUNTERCLOCKWISE;
